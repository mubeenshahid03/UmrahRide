...
function Packages() {
  ...
  <Bookingmodel />
   <div className='div-btn '>
    ...
    {isSpin? (<div style={{ textAlign: "center", marginTop: "60px" }}>
            <Spinner />
          </div>) :
 ...
 
 {
        packages.map((car,index)=>{
         return <Col xs={24} sm={12} md={12} lg={12} xl={10}  style={{marginTop:"40px"}} >  <Pcard car={car} detail={car.vehicle}  key={index}/> </Col>
